...
public class ModularRealmUniqueTokenAuthenticator extends ModularRealmAuthenticator {

	private static final Logger logger = LoggerFactory.getLogger(ModularRealmUniqueTokenAuthenticator.class);
